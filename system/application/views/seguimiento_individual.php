    ...
    <div class="col col_16">
        ...
        <article>            
                <table id="customers" class="ui-corner-all">
                    <thead>
                        <h3>Historial de Seguimientos <a href="<?php echo base_url();?>boletin_controller/seguimiento_individual_pdf/<?php echo $numero_boletin;?>"><img style="width:32px" src="<?php echo base_url();?>imagenes/LogoPDF.png"></a></h3>
                    </thead>
                    <tr>
                        <th>Fecha</th>
                        <th>Medio</th>
