<?php
    ...
    class VerticalBarChart extends BarChart {
         ...
         */
        public function VerticalBarChart($width = 800, $height = 250) {
        ...
        protected function printAxis() {
            ...
            for ($i = 0; $i <= $pointCount; $i++) {
                ...
                imagerectangle($img, $x - 1, $graphArea->y2 + 20, $x, $graphArea->y2 + 3, $palette->axisColor[0]->getColor($img));
        ...
        protected function printBar() {
            ...
            for ($j = 0; $j < $serieCount; $j++) {
                ...
                for ($i = 0; $i < $pointCount; $i++) {
                    ...
                    $columnWidthWithMargin = $columnWidth * (1 - $this->emptyToFullRatio * 0.2);
